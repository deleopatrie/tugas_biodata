package com.example.deleo.tugas_biodata;
...
public class MainActivity extends AppCompatActivity {
    ...
    String no_telp = "085715208995";
    String email = "deleopatrie@gmail.com";
    ...
    public void Email(View view) {
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto","deleopatrie@gmail.com", null));
